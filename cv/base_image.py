...
# -*- coding:utf-8 -*-
import cv2
from cv.coordinate import Rect, Size
from utils.base import auto_increment
from cv.utils import read_image, bgr_2_gray, bytes_2_img
from cv.thresholding import otsu
import numpy as np
